...
#Sch name = JA2
set_property PACKAGE_PIN L2 [get_ports SI_SIO0]
set_property IOSTANDARD LVCMOS33 [get_ports SI_SIO0]
#Sch name = JA3
set_property PACKAGE_PIN J2 [get_ports SO_SIO1]
set_property IOSTANDARD LVCMOS33 [get_ports SO_SIO1]
#Sch name = JA4
set_property PACKAGE_PIN G2 [get_ports SCK]
set_property IOSTANDARD LVCMOS33 [get_ports SCK]
#Sch name = JA7
set_property PACKAGE_PIN H1 [get_ports SIO2]
set_property IOSTANDARD LVCMOS33 [get_ports SIO2]
#Sch name = JA8
set_property PACKAGE_PIN K2 [get_ports HOLD_N_SIO3]
